...
#########################################################################################################
##### datafiles contain temp, RH, and dew point. this script will pull out each and merge the files #####
#########################################################################################################
path1 = "F:/Users/Jason/Desktop/UHI_data_processing/raw_CSVs"	##set path to folder containing CSVs
path2 = "F:/Users/Jason/Desktop/UHI_data_processing/"			##set path to working directory
...
for (i in 1:length(list1)){
	...
	Date$H.from.rise=ifelse((Date$now-Date$prev.sunrise)*24>24,(Date$now-Date$prev.sunrise-1)*24,(Date$now-Date$prev.sunrise)*24)
	Date$H.from.set=ifelse((Date$now-Date$prev.sunset)*24>24,(Date$now-Date$prev.sunset-1)*24,(Date$now-Date$prev.sunset)*24)
	Date$H.to.rise=ifelse((Date$now-Date$next.sunrise)*-24>24,(Date$now-Date$next.sunrise+1)*-24,(Date$now-Date$next.sunrise)*-24)
	Date$H.to.set=ifelse((Date$now-Date$next.sunset)*-24>24,(Date$now-Date$next.sunset+1)*-24,(Date$now-Date$next.sunset)*-24)
